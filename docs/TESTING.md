...
- the detail chart switches between `1 day`, `7 days`, and `30 days` with `[` and `]`, news lines omit URLs and show time/category metadata, and the sentiment pane shows the Fear & Greed value when the provider succeeds;
